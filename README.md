...
| `superagent-capture` | Session auto-capture: distills each session transcript into memory-os entries (summary + decisions + corrections) from the Stop hook. Rule-based, API-free, upserts per session. |
