...
[[ "$LINES" == "1" ]] || { echo "FAIL: prune kept $LINES lines, want 1"; cat "$TMPHOME/.paarth/brain/patterns.jsonl"; exit 1; }
grep -q '"p-1111"' "$TMPHOME/.paarth/brain/patterns.jsonl" || { echo "FAIL: protected p-1111 was pruned"; exit 1; }
