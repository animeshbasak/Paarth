...
[[ -f "$TMPHOME/.paarth/auto-downgrade.flag" ]] || { echo "FAIL: auto-downgrade.flag missing"; exit 1; }
grep -q "sonnet" "$TMPHOME/.paarth/auto-downgrade.flag" || { echo "FAIL: flag missing target"; exit 1; }
