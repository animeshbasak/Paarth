---
name: income:social-content
description: [income] Creates, repurposes, and schedules social media content (posts, threads, short-form video scripts) and runs social listening. Triggers on "LinkedIn post", "Twitter thread", "content calendar", "what should I post", "TikTok video", "social media strategy".
---
