---
name: income:productized-service
description: [income] Converts dev expertise into fixed-scope, fixed-price productized offers — audits, sprints, retainers — with positioning and a sales page outline. Triggers on "productized service", "package my services", "fixed-price offer", "service offer", "audit as a service".
---

# income:productized-service

Origin: first-party SuperAgent skill (not vendored). For developers who want
