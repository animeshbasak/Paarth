---
name: income:cold-email
description: [income] Writes B2B cold outreach emails and multi-touch follow-up sequences that get replies, covering subject lines, openers, and personalization. Triggers on "cold outreach", "prospecting email", "outbound email", "cold email campaign", "SDR email", "follow-up sequence", "nobody's replying to my emails".
---
