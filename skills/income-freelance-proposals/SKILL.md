---
name: income:freelance-proposals
description: [income] Turns a client conversation into a scoped, priced dev-consulting proposal — discovery summary, options table, retainer path, kill criteria. Triggers on "client proposal", "statement of work", "SOW", "consulting offer", "retainer", "scope this engagement".
---

# income:freelance-proposals

Origin: first-party SuperAgent skill (not vendored). Written for developers selling
