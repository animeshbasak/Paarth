...
def _log_saved(n: int) -> None:
    try:
        d = os.path.expanduser("~/.paarth/metrics")
...
def main():
    ...
    optimized = None
    optimizer = shutil.which("paarth-optimize") or os.path.join(
        os.path.dirname(os.path.abspath(__file__)), "..", "bin", "paarth-optimize"
    )
    ...
    # than none. Kill switch: PAARTH_INJECT_BUDGET=0|false|off.
