...
Run via ``paarth-memory-mcp`` (entry-point) or
``python -m memory_os.server``.

Environment variables:
    PAARTH_MEMORY_HOME       Storage dir (default ~/.paarth/memory-os)
    PAARTH_MEMORY_NAMESPACE  Override the auto-detected git-root namespace
"""
