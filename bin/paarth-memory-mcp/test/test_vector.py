...
def vector_on(monkeypatch):
    monkeypatch.setenv("PAARTH_MEMORY_VECTOR", "on")
    monkeypatch.setenv("PAARTH_MEMORY_VECTOR_BACKEND", "memory")
    vector.reset_store()
